...
// Дни рождений
//----------------------------------------------------------------------------
$NUM_ALARM_DAYES=31; //Количество дней, за которое необходимо предупреждать о днях рождениях.
...
$BIRTH_VIS_ROW_NUM=5; // Количество видимых предупреждений о ближайших днях рождения. Остальные скрываются под стрелочку.
...
$PDF_LOGO=""; //Logo file for pdf page 250x100
